...
class Question(ABC):
    def __init__(self, qtype: str, name: str, message: str, choices: List[str] = [], default: Any = None):
        self.metadata = dict()
...
class CheckboxQuestion(Question):
    def __init__(self, name: str, message: str, choices: List[str]):
        super(CheckboxQuestion, self).__init__("checkbox", name, message, [{"name": choice} for choice in choices])
...
class ListQuestion(Question):
    def __init__(self, name: str, message: str, choices: List[str]):
        super(ListQuestion, self).__init__("list", name, message, choices=[{"name": choice} for choice in choices], default=0)
